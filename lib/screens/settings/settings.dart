...
import 'package:travelwise/screens/map/location_background.dart';
...
class _AppSettingsState extends State<AppSettings> {
  ...
  int selectedOption_liveshare = 1;
  int notifications = 5;
  ...
  setliveshare() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt('liveshare', selectedOption_liveshare);
  ...
  getSharedPreferences() async {
    ...
    setState(() {
      ...
      selectedOption_liveshare = prefs.getInt('liveshare') ?? 1;
    });
  }
  ...
  Widget liveshareDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
        return StatefulBuilder(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ListTile(
                      ...
                      leading: Radio(
                        value: 1,
                        groupValue: selectedOption_liveshare,
                        onChanged: (value) {
                          setState(() {
                            selectedOption_liveshare = value!;
                          });
                        },
                      ),
                    ),
